        ...
        <main class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8">
            <div class="max-w-2xl w-full space-y-8">
                <div class="text-center">
                    <h2 class="text-4xl font-extrabold text-emerald-600 dark:text-emerald-400">Welcome Back</h2>
                ...
                <div class="bg-white dark:bg-slate-800 shadow-lg rounded-lg p-8">
                    @if (session('status'))
                        <div class="mb-4 p-3 bg-green-50 dark:bg-green-900/50 border border-green-200 dark:border-green-700 text-green-800 dark:text-green-200 rounded-md text-sm">
                            {{ session('status') }}
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" class="text-sm text-emerald-600 dark:text-emerald-400 hover:text-emerald-500">
                                    Forgot password?
                                </a>
                            @endif
                        </div>
                        ...
                        <p class="text-center text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <a href="{{ route('register') }}" class="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 font-medium">
                                Register
                            </a>
                        </p>
                    </form>
